      ...
      <div className="pb-12 px-2 sm:px-5 md:px-10 lg:px-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-6 gap-y-6 mt-[30px] ">
          <div className="">
            ...
            <div className="flex p-6 dark:bg-transparent bg-[#FFF0F0] dark:border dark:border-red-50 rounded-lg mb-4">
          ...
          <div>
            ...
            <div className="p-6 dark:bg-transparent bg-[#FFFDF5] dark:border dark:border-red-50 rounded-lg mb-4">
              <div className=" flex flex-wrap space-y-2">
                <h5 className=" text-gray-500 dark:text-white text-lg ">
                  2023 / Act. Maracaibo - Venezuela
                </h5>
                ...
                <div className="leading-8 text-gray-lite dark:text-[#A6A6A6]">
                  Actualmente, desarrollo interfaces de usuario para un sistema
                  de facturación utilizando React, Tailwind CSS y Flowbite. Me
                  integro con API's como Saint, The Factory y Banesco para
                  garantizar un proceso fluido y preciso.
                </div>
              </div>
            </div>

            <div className="p-6 dark:bg-transparent bg-[#E9F8FF]  dark:border dark:border-red-50 rounded-lg mb-4">
              <div className=" flex flex-wrap space-y-2">
                <h5 className=" text-gray-500 dark:text-white text-lg ">
                  2023 Remoto
                </h5>
                <h3 className="dark:text-white text-xl font-semibold">
                  <span className="font-bold ">Developer Full Stack</span>
                  <br />
                  No Country
                </h3>
                <div className="leading-8 text-gray-lite dark:text-[#A6A6A6]">
                  Mi experiencia abarca tanto el front-end como el back-end. En
                  la red social POV, lideré la construcción de la interfaz de
                  usuario con React y Tailwind CSS, e integré el proyecto
                  utilizando GitHub. En MiFinaz, una app de finanzas personales,
                  desarrollé el back-end, creando la lógica y la estructura de
                  la base de datos.
                </div>
              </div>
            </div>
            ...
            <div className="p-6 dark:bg-transparent bg-[#E9F8FF] dark:border dark:border-red-50 rounded-lg mb-4">
              <div className=" flex flex-wrap space-y-2">
                ...
                <div className="leading-8 text-gray-lite dark:text-[#A6A6A6]">
                  <ol>
                    <li>
                      -Liderar la planificación, ejecución y entrega sobre un
                      proyecto de almacenes llamado K2O.
                    </li>
                    <li>
                      -Gestionar un equipo de 2 profesionales de tecnología.
                    </li>
                    <li>
                      asegurando la cohesión y la calidad del trabajo entregado.
                    </li>
                    <li>-Atención al usuario y reporte de fallas.</li>
                  </ol>
                </div>
              </div>
            </div>

            <div className="p-6 dark:bg-transparent bg-[#FFF0F0] dark:border dark:border-red-50 rounded-lg mb-4">
              <div className="flex flex-wrap space-y-2">
                <h5 className=" text-gray-500 dark:text-white text-lg ">
                  2018 / 2019 Maracaibo - Venezuela
                </h5>
                <h3 className="dark:text-white text-xl font-semibold ">
                  <span className="font-bold "> Analista de Sistemas</span>
                  <br />
                ...
                <div className="leading-8 text-gray-lite dark:text-[#A6A6A6]">
                  <ol>
                    <li>
                      *Desarrollo de proyectos en PHP-MySQL. *Diseño front-end
                      en HTML5, JQuery, Bootstrap y CSS3.
                    </li>
                    <li>
                      *Planificación de las tareas y cumplimiento de los
                      objetivos,
                    </li>
                    <li>
                      *Codificación eficaz de cambios y alteraciones de software
                      en base a especificaciones de diseño concretas.
                    </li>
