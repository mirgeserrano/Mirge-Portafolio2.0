export const Facuracion = () => {
  return (
    <svg
      className="flex-shrink-0 w-6 h-6   transition duration-75 dark:text-gray-400 group-hover:text-gray-400 dark:group-hover:text-white"
      viewBox="0 0 22 22"
      strokeWidth="1.5"
      fill="none"
